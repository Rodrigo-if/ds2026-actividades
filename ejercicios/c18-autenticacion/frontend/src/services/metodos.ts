...
//Mapro de LibroValidado a LibroOL
export function mapToLibroOL(libro: LibroValidado): LibroOL {
  return {
    key: crypto.randomUUID(),
    title: libro.title,
    author_name: libro.author_name.map(a => a.name),
    cover_i: Number(libro.cover_i) || 0,
  };
}
